...
class GPT(commands.Cog):
    ...
    @bridge.bridge_command(brief = "Grubhard's Wisdom")
    ...
    @bridge.bridge_command(brief = "Grubbley's Wisdom???")
    async def grubbley(self, ctx, text):
        grub_text = berlock_gpt.grubbleyGPT(text)
        embed = discord.Embed(title="The Words of Grubbley",
                              url="https://zombo.com",
                          colour=0x6A4A3F)
        embed.set_author(name="Grubbley",
                         icon_url="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/8aa98588-c6d6-4070-84dc-1377a903e813/d85tkr7-6eaf66f5-2025-40d9-af31-9fb3c5009ef6.jpg/v1/fit/w_600,h_690,q_70,strp/grub_cartoon___terranem_nematodes_by_growngraphic_d85tkr7-375w-2x.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..OlcG-B4QcphqEIIushaz9TkLNSX41qmL-jy4oeNzHww")
        embed.add_field(name="Grubworld",
                        value=f"{grub_text}")
        emoji = discord.utils.get(ctx.guild.emojis, name='ohmydog')
